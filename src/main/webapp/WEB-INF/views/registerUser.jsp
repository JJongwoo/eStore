...
<div class="container-srapper">
	<div class="container">
		...
		<sf:form action="${pageContext.request.contextPath }/register"
			...
			<div class="form-group">
				<label for="email">이메일 주소</label><span style="color: #ff0000">${emainMsg }</span>
			...
			<div class="form-group">
				...
				<sf:input path="shippingAddress.address" id="shippingAddress" class="form-control"/>
			</div>
